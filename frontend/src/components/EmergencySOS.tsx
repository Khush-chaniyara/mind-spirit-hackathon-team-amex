      ...
      {isEmergencyActive ? (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button className="w-full border text-sm px-3 py-2">
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button 
              className="w-full h-14 text-lg font-bold shadow-emergency hover:scale-105 transition-all duration-200 bg-destructive text-white"
            >
