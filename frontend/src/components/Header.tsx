      ...
      <div className="container flex h-16 items-center">
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          <nav className="flex items-center">
            ...
            <Button 
              onClick={toggleTheme}
              className="ml-4 bg-transparent px-2 py-1"
            >
            ...
            {isAuthenticated ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="ml-2 border px-2 py-1">
              ...
              <Button className="ml-2 border px-2 py-1" asChild>
                <Link to="/login">
                  <User className="h-4 w-4 mr-2" />
                  Login
                </Link>
            ...
            <Button className="ml-2 md:hidden bg-transparent px-2 py-1">
